      ...
      <div className="container relative">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/80 leading-relaxed mb-8 max-w-2xl mx-auto">
            Ya seas consumidor, agricultor, ganadero o elaborador de preparados, 
            aquí tienes un espacio para conectar de forma directa y transparente.
          </p>
          ...
          <p className="mt-8 text-sm text-primary-foreground/60">
            100% gratuito · Sin comisiones · Sin ánimo de lucro
          </p>
        </div>
      </div>
    </section>
